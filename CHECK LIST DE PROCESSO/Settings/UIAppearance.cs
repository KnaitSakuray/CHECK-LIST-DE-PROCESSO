...
namespace LED_EPL.Settings
{
    public struct UIAppearance
    {
        ...
        internal static Color PrimaryStyleColor = RJColors.Petunia; //Sets or gets the style color of the form title bar
        internal static Color StyleColor = RJColors.Petunia; //Sets or gets the style color of the buttons, comboboxs, datetime pickers, datagridviews, checkboxs, radio buttons and others (the color is a little more opaque than the PrimaryStyleColor field - See SettingsManagger Class)   
        ...
        internal static Color PrimaryTextColor = RJColors.DarkTextColor;//Sets or gets the color of the text of the text boxes, combo box, date time picker (The color is a little more highlighted than the TextColor field - See SettingsManagger Class)
        internal static Color TextColor = RJColors.DarkTextColor;//Sets or gets Text Color of the label, radio button and others, also applies to the text and BarIcon control in the title bar of the main form in the supernova style.
        internal static Color FormBorderColor = RJColors.Petunia;//Sets or gets the border color of the form        
        ...
        internal static string TextFamilyName = "Segoe UI";
        internal static float TextSize = 11F;//Sets a default font size, applies to most custom controls at design time, 
